        ...
        <div className="grid lg:grid-cols-2 gap-6 lg:gap-12 items-center">
          ...
          <div className="relative flex justify-center items-center h-[350px] lg:h-[450px]">
            ...
            <Link href={aboutUrl} className="relative z-20 group cursor-pointer">
              <div className="w-48 h-48 rounded-full bg-deep-brown flex flex-col items-center justify-center gap-3 relative overflow-hidden transition-transform duration-500 group-hover:scale-105 shadow-xl p-4">
                <ArrowRight className="w-8 h-8 text-gold relative z-10 group-hover:translate-x-1 transition-transform duration-300" />
                <span className="text-gold text-center font-heading text-xl leading-tight relative z-10 group-hover:scale-110 transition-transform drop-shadow-md">
                  {buttonText}
                </span>
              </div>
